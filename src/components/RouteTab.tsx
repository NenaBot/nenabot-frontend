  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-1 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="flex items-center gap-1 text-sm mb-2 text-[var(--md-sys-color-on-surface)]">
                Scan Pattern
                <Info className="w-3.5 h-3.5 text-[var(--md-sys-color-on-surface-variant)]" title="Pattern for area coverage" />
              </label>
              <select 
            ...
            <div>
              <label className="flex items-center gap-1 text-sm mb-2 text-[var(--md-sys-color-on-surface)]">
                ...
                <Info className="w-3.5 h-3.5 text-[var(--md-sys-color-on-surface-variant)]" title="Measurement density" />
              </label>
              <input 
                type="number" 
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="flex items-center gap-1 text-sm mb-2 text-[var(--md-sys-color-on-surface)]">
                  Width (cm)
                  <Info className="w-3.5 h-3.5 text-[var(--md-sys-color-on-surface-variant)]" title="Scan area width" />
                </label>
                <input 
                  type="number" 
              ...
              <div>
                <label className="flex items-center gap-1 text-sm mb-2 text-[var(--md-sys-color-on-surface)]">
                  Height (cm)
                  <Info className="w-3.5 h-3.5 text-[var(--md-sys-color-on-surface-variant)]" title="Scan area height" />
                </label>
                <input 
                  type="number" 
        ...
        <button className="w-full px-6 py-3 bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] rounded-full flex items-center justify-center gap-2 hover:shadow-lg transition-all text-sm">
