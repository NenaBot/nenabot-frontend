    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 border border-(--md-sys-color-outline) rounded-lg hover:bg-(--md-sys-color-surface-variant) transition-colors text-sm flex items-center gap-2">
          ...
          <button className="px-4 py-2 bg-(--md-sys-color-primary) text-(--md-sys-color-on-primary) rounded-lg hover:shadow-md transition-all text-sm flex items-center gap-2">
      ...
      <div className="border border-(--md-sys-color-outline-variant) rounded-2xl p-12 bg-(--md-sys-color-surface-container-lowest)">
        <div className="max-w-md mx-auto text-center">
          <div className="w-20 h-20 bg-(--md-sys-color-primary-container) rounded-full flex items-center justify-center mx-auto mb-4">
            <BarChart3 className="w-10 h-10 text-(--md-sys-color-on-primary-container)" />
          </div>
          ...
          <div className="flex flex-col gap-3 max-w-xs mx-auto">
            <button className="px-6 py-3 bg-(--md-sys-color-primary) text-(--md-sys-color-on-primary) rounded-full hover:shadow-lg transition-all text-sm">
              Start New Scan
            </button>
            <button className="px-6 py-3 border border-(--md-sys-color-outline) rounded-full hover:bg-(--md-sys-color-surface-variant) transition-colors text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="border border-(--md-sys-color-outline-variant) rounded-xl p-5 bg-(--md-sys-color-surface-container-low)">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-(--md-sys-color-tertiary-container) rounded-lg">
              <TrendingUp className="w-5 h-5 text-(--md-sys-color-on-tertiary-container)" />
            </div>
        ...
        <div className="border border-(--md-sys-color-outline-variant) rounded-xl p-5 bg-(--md-sys-color-surface-container-low)">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-(--md-sys-color-secondary-container) rounded-lg">
              <BarChart3 className="w-5 h-5 text-(--md-sys-color-on-secondary-container)" />
            </div>
        ...
        <div className="border border-(--md-sys-color-outline-variant) rounded-xl p-5 bg-(--md-sys-color-surface-container-low)">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-(--md-sys-color-primary-container) rounded-lg">
              <Download className="w-5 h-5 text-(--md-sys-color-on-primary-container)" />
            </div>
